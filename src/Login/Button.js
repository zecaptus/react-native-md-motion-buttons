...
import { StyleSheet, Animated, Text, View, ActivityIndicator, UIManager, findNodeHandle } from 'react-native';
...
export default class Button extends Component {
    ...
    componentDidMount(){
        setTimeout(() => {
            UIManager.measure(
                findNodeHandle(this),
                (fx, fy, width, height, px, py) => this.setState({px, py, width, height})
            );
        },0);
    }
    ...
    render() {
        ...
        return (<Ripple onPress={this._onPressButton}
